...
#ifndef IONSTOPPINGDATA_HH
#define IONSTOPPINGDATA_HH
...
class IonStoppingData : public G4VIonDEDXTable {

 public:
   IonStoppingData(const G4String& leDirectory);
   virtual ~IonStoppingData();
