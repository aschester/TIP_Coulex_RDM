...
#ifndef IONPARAMETRISEDLOSSMODEL_HH
#define IONPARAMETRISEDLOSSMODEL_HH
...
class IonParametrisedLossModel : public G4VEmModel {

 public:
   IonParametrisedLossModel(const G4ParticleDefinition* particle = 0,
                              const G4String& name = "ParamICRU73");

   virtual ~IonParametrisedLossModel();
 ...
 private:
   ...
   IonParametrisedLossModel & operator=(
                              const IonParametrisedLossModel &right);
   IonParametrisedLossModel(const IonParametrisedLossModel &);
...
#include "IonParametrisedLossModel.icc"
