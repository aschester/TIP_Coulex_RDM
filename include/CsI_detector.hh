...
class CsI_detector 
{
  ...
  G4double GetCsIDetectorThickness(){return CsI_detector_thickness/mm;};
  G4LogicalVolume* GetLog(){return CsI_detector_log;};
  G4double GetCsIDensity(){return CsI_Material->GetDensity()/g*cm3;};
  G4Material* GetCsIMaterial(){return CsI_Material;};
