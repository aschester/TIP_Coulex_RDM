...
void Reaction::TargetFaceCrossSection()
{
 ...
 if(Ex1*Ex2!=0.)
  ...
  proj=G4ParticleTable::GetParticleTable()->GetIon(Z1,A1,Ex1);
  rec=G4ParticleTable::GetParticleTable()->GetIon(Z2,A2,Ex2);
  ...
  if(ProjEx)
	...
	proj->SetDecayTable(ProjDecTab);
      ...
      GammaDecayChannel *ProjDec = new GammaDecayChannel(-1,proj,1,Ex1);
	...
	rec->SetDecayTable(RecDecTab);
      ...
      GammaDecayChannel *RecDec = new GammaDecayChannel(-1,rec,1,Ex2);
