...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  tank_vis_att->SetVisibility(false);
...
void DetectionSystemGriffin::ConstructColdFinger()
{
  ...
  cold_finger_vis_att->SetVisibility(false);

  G4VisAttributes* structureMat_vis_att = new G4VisAttributes(G4Colour(0.5,0.5,0.5));
  structureMat_vis_att->SetVisibility(false);
...
void DetectionSystemGriffin::ConstructNewSuppressorCasingWithShells()
{
  ...
  G4VisAttributes* Suppressor_vis_att = new G4VisAttributes(G4Colour(0.25,0.25,0.25));
  ...
  back_innards_vis_att->SetVisibility(false);
...
void DetectionSystemGriffin::ConstructNewHeavyMet()
{
  ...
  G4VisAttributes* HeviMet_vis_att = new G4VisAttributes(G4Colour(0.25,0.25,0.25));
