...
//
//   Changed default value of                        4 Nov. 2015  A.Chester
//   SetSecondaryWeightByProcess() flag so that
//   tracks inheret weights from parents by 
//   default.
// --------------------------------------------------------------

#include "ParticleChange.hh" // custom particle change class
#include "G4Track.hh"
#include "G4Step.hh"
...
G4VParticleChange::G4VParticleChange():
   ...
   fSetSecondaryWeightByProcess(false), // changed to false
